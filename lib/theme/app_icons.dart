...
class AppIcon {
  ...
  static const IconData persons = IconData(0xf0db, fontFamily: 'MaterialIcons');
  static const IconData addPerson =
      IconData(0xf275, fontFamily: 'MaterialIcons');
  static const IconData info = IconData(0xe33d, fontFamily: 'MaterialIcons');
  ...
  static const IconData circleArrowForward =
      IconData(0xf02dc, fontFamily: 'MaterialIcons');
  static const IconData circleArrowBackward =
      IconData(0xf02db, fontFamily: 'MaterialIcons');
  static const IconData myNeighbor =
