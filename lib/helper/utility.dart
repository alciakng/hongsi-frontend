...
import 'package:intl/intl.dart'
    hide
        TextDirection; // 아래 getTextLine 함수 사용을 위하여 intl 내부 TextDirection 함수 hide 처리
...
void cprint(
  ...
  if (kDebugMode) {
    if (errorIn != null) {
      print(
          '****************************** error ******************************');
      developer.log('[Error][uid]' + uid.toString(),
...
/*
  ...
  */
  ...
  static void copyToClipBoard({
    ...
    customSnackBar(scaffoldMessengerKey, message);
  }
